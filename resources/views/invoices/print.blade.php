...
.inv-banner{background:#7b1313;color:#fff !important;text-align:center;font-size:1.45rem;font-weight:600;letter-spacing:8px;padding:8px 0;margin:6px 0 18px;}
...
.sig{margin-top:30px;font-size:0.86rem;} .sig-name{font-weight:700;font-size:0.92rem;margin-top:2px;} .sig-role{color:#333;}
